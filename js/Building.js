var Building = function() {
	...
	var lift = new Lift(40,liftHeight,40,true,1,FLOOR_HEIGHT);
	...
	_mesh.applyMatrix(matr.makeRotationY(0));
	...
	var _api = {
		...
		requestLiftOpen: function(nextStep) {
